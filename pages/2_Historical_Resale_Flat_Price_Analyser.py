...
form.write("Warning: Analysis time depends on the number of returned rows and may take up to 5 minutes on unfiltered data. Please filter as much as possible before clicking analyse.")
